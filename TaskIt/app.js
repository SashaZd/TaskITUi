...
var settingsStore_URL, onlyChoresStore_URL;
...
Ext.application({
    ...
    views: [
        'Main', 'Settings', 'Home', 'Groceries', 'ChoreList', 'ChoreListPanel', 'GroceryList', 'Start', 'Login', 'Setup', 'OthersChoreList', 'Signup', 'RoommatesList', 'OnlyChoresList', 'DefaultTaskList'
    ],
